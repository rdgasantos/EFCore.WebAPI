...
namespace EFCore.WebAPI.Migrations
{
    ...
    [Migration("20200927162410_HeroisBatalhas_Identidade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore.WebAPI.Arma", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EFCore.WebAPI.Batalha", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EFCore.WebAPI.Heroi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EFCore.WebAPI.Arma", b =>
                {
                    b.HasOne("EFCore.WebAPI.Heroi", "Heroi")
                        .WithMany("Armas")
            ...
            modelBuilder.Entity("EFCore.WebAPI.Models.HeroiBatalha", b =>
                {
                    b.HasOne("EFCore.WebAPI.Batalha", "Batalha")
